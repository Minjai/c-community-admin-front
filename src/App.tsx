        ...
        <NavigationService>
          <Routes>
            ...
            <Route path="/" element={
              ...
              {/* 가이드라인 관리 */}
              <Route path="guidelines/casino" element={<NotImplemented pageName="카지노 가이드라인" />} />
              <Route path="guidelines/sports" element={<NotImplemented pageName="스포츠 가이드라인" />} />
              <Route path="guidelines/crypto" element={<NotImplemented pageName="암호화폐 가이드라인" />} />
              
              {/* 데이터 관리 */}
              <Route path="data/casino-games" element={<NotImplemented pageName="카지노 게임 관리" />} />
              <Route path="data/casino-recommendations" element={<NotImplemented pageName="카지노 게임 추천" />} />
              <Route path="data/sports" element={<NotImplemented pageName="스포츠 종목 관리" />} />
              <Route path="data/sports-recommendations" element={<NotImplemented pageName="스포츠 종목 추천" />} />
              
              {/* 리뷰 업체 관리 - 관리자 권한 필요 */}
              <Route path="reviews/casino" element={
              ...
              {/* 커뮤니티 관리 */}
              <Route path="community/notices" element={<NotImplemented pageName="공지사항 관리" />} />
              ...
              {/* 기타 관리 - 관리자 권한 필요 */}
              <Route path="settings/user-levels" element={
                <RoleBasedRoute allowedRoles={['admin', 'superadmin']}>
                  <NotImplemented pageName="회원 등급 관리" />
                </RoleBasedRoute>
              } />
              <Route path="settings/transfer-banners" element={<NotImplemented pageName="송금 배너 관리" />} />
              <Route path="settings/site-menu" element={
                <RoleBasedRoute allowedRoles={['admin', 'superadmin']}>
              ...
              <Route path="settings/footer" element={
                <RoleBasedRoute allowedRoles={['admin', 'superadmin']}>
